...
L'inventaire ICO ou ICNS est disponible dans le résultat de validation et d'import pour la session en cours. Il n'est pas encore persisté. Le schéma SQLite reste en version 2 et le format de bibliothèque en version 1.
